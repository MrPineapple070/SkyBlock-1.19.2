...
/**
 * An {@link AccessoryItem} that gives a 1% discount on most shops.<br>
 * <a href="https://wiki.hypixel.net/Shady_Ring">Shady Ring</a>
 *
...
public class ShadyRing extends AccessoryItem {
	...
	protected ItemStack getUpgrade() {
		return new ItemStack(AccessoryInit.crooked_artifact.get());
	}
}