 ...
 * <a href="https://wiki.hypixel.net/Zombie_Ring">Zombie Ring</a>
 *
...
public class ZombieRing extends AccessoryItem {
	...
	@Nonnull
	@Immutable
	private static final Component info = Component.translatable("accessory.zombie", 10).withStyle(ChatFormatting.GRAY);
	...
	protected ItemStack getUpgrade() {
		return new ItemStack(AccessoryInit.zombie_artifact.get());
	}
}