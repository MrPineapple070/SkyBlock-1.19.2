...
/**
 * An {@link AccessoryItem} that ensures that Monster below level 5 will no longer
 * target you.<br>
 * <a href= "https://wiki.hypixel.net/Intimidation_Ring">Intimidation Ring</a>
 *
...
public class IntimidationRing extends AccessoryItem {
	...
	protected ItemStack getUpgrade() {
		return new ItemStack(AccessoryInit.intimidation_artifact.get());
	}
}