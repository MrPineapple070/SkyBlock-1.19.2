...
/**
 * An {@link AccessoryItem} that decreases damage taken from Sea Creatures by
 * 10%.<br>
 * <a href="https://wiki.hypixel.net/Sea_Creature_Ring">Sea Creature Ring</a>
 *
...
public class SeaCreatureRing extends AccessoryItem {
	...
	protected ItemStack getUpgrade() {
		return new ItemStack(AccessoryInit.sea_creature_artifact.get());
	}
