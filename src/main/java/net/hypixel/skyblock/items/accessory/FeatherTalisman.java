...
/**
 * An {@link AccessoryItem} that increases distance for fall damage by 5 blocks.<br>
 * <a href="https://wiki.hypixel.net/Feather_Talisman">Feather Talisman</a>
 *
...
public class FeatherTalisman extends AccessoryItem {
	...
	protected ItemStack getUpgrade() {
		return new ItemStack(AccessoryInit.feather_ring.get());
	}
}