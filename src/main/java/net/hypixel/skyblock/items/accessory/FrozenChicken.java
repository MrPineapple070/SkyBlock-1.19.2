...
/**
 * An {@link AccessoryItem} that gives +1% speed.<br>
 * <a href="https://wiki.hypixel.net/Frozen_Chicken">Frozen Chicken</a>
 *
...
public class FrozenChicken extends AccessoryItem {
	...
	@Nonnull
	@Immutable
	private static final Component info = Component.translatable("accessory.frozen", StatString.speed)
