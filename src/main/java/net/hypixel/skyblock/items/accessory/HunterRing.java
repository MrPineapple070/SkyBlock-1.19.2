...
/**
 * An {@link AccessoryItem} that increases Combat XP by 5%.<br>
 * <a href="https://wiki.hypixel.net/Hunter_Ring">Hunter Ring</a>
 *
...
public class HunterRing extends AccessoryItem {
	...
	@Nonnull
	@Immutable
	private static final Component info = Component.translatable("accessory.hunter", 5).withStyle(ChatFormatting.GRAY);
