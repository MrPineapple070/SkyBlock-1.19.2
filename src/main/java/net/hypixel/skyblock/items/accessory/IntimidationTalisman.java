...
/**
 * An {@link AccessoryItem} that ensures that Monsters under level 1 will no longer
 * target the player.<br>
 * <a href= "https://wiki.hypixel.net/Intimidation_Talisman">Intimidation
 * Talisman</a>
 *
...
public class IntimidationTalisman extends AccessoryItem {
	...
	protected ItemStack getUpgrade() {
		return new ItemStack(AccessoryInit.intimidation_ring.get());
	}
}