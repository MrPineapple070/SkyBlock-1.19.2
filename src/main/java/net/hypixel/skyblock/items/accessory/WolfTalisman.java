...
/**
 * An {@link AccessoryItem} that reduces damage taken from {@link Wolf} by
 * 5%.<br>
 * <a href="https://wiki.hypixel.net/Wolf_Talisman">Wolf Talisman</a>
 *
...
public class WolfTalisman extends AccessoryItem {
	...
	protected ItemStack getUpgrade() {
		return new ItemStack(AccessoryInit.wolf_ring.get());
	}
}