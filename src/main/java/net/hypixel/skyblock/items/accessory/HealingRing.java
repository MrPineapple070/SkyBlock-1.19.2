...
/**
 * An {@link AccessoryItem} that increases healing by 10%.<br>
 * <a href="https://wiki.hypixel.net/Healing_Ring">Healing Ring</a>
 *
...
public class HealingRing extends AccessoryItem {
	...
	@Nonnull
	@Immutable
	private static final Component info = Component.translatable("accessory.healing", 15)
