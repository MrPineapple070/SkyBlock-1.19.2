...
/**
 * An {@link AccessoryItem} that increases Combat XP by 2%.<br>
 * <a href="https://wiki.hypixel.net/Hunter_Talisman">Hunter Talisman</a>
 *
...
public class HunterTalisman extends AccessoryItem {
	...
	protected ItemStack getUpgrade() {
		return new ItemStack(AccessoryInit.hunter_ring.get());
	}
}