...
/**
 * An {@link AccessoryItem} grants a small stats increase when stored in the
 * {@link Inventory} or Accessory Bag.<br>
 * <a href="https://wiki.hypixel.net/Bat_Talisman">Bat Talisman</a>
 *
...
public class BatTalisman extends AccessoryItem {
	...
	private static final Component info = Component
			.translatable("accessory.bat_talisman", StatString.health, StatString.speed, StatString.intelligence)
	...
	protected ItemStack getUpgrade() {
		return new ItemStack(AccessoryInit.bat_ring.get());
	}
}